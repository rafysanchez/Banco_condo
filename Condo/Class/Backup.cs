...
namespace Condo.Class
{
    class Backup
    {
        ...
        const string db_nome = "condo";
        public string db_caminhoBackup = frm_bakup.local_backup;//pega do formulario txt_localBAckup
        ...
        public void Realizar_Backup()
        {
            try
            {
               ...
               // psinfo.FileName = "C:\\Program Files (x86)\\MySQL\\MySQL Workbench 6.0 CE\\mysqldump";//caminho de instalação mysql
                psinfo.FileName = frm_bakup.caminho_instalacao_Mysql + "\\mysqldump";
                psinfo.RedirectStandardInput = false;
                psinfo.RedirectStandardOutput = true;
                psinfo.Arguments = ("--host=localhost --user=root --password= condo ");//Acesso ao banco                
           ...
           // string strRestoreNome = db_caminhoBackup + Script_sql;
            ...
            try
            {
               ...
               // psinfo.FileName = "C:\\Program Files (x86)\\MySQL\\MySQL Workbench 6.0 CE\\mysql";//caminho de instalação mysql
                psinfo.FileName = frm_bakup.caminho_instalacao_Mysql + "\\mysql";
